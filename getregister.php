    ...
    <div class="register">
       ...
       <div class="reg2">
        <form action="registration.php" method="POST" class="form">
            ...
            <input type="text" placeholder="Enter your first name" name="firstname" class="input" required><br>
            <label>Last name</label><br>
            <input type="text" placeholder="Enter your last name" name="lastname" class="input" required><br>
